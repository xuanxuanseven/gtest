<?php
/**
 * block.l10n.php - Smarty gettext block plugin
 *
 ...
 * @return string
 */
function smarty_block_l10n($params, $text)
{
    if (!isset($text)) {
        return $text;
    }
    ...
    if (isset($count) && isset($plural)) {
        if (is_null($context)) {
            $text = (isset($domain) ? L10N\L10N::_n($text, $plural, $count,
                                                    $domain) : L10N\L10N::_n($text, $plural,
                                                                             $count));
        } else {
            $text = (isset($domain) ? L10N\L10N::_nx($text,
                                                     $plural,
                                                     $count,
                                                     $context,
                                                     $domain) : L10N\L10N::_n($text,
                                                                              $plural,
                                                                              $count));
        }
    } else {
        if (!is_null($context)) {
            $text = (isset($domain) ? L10N\L10N::_x($text, $context,
                                                    $domain) : L10N\L10N::_x($text, $context));
        } else {
            $text = (isset($domain) ? L10N\L10N::__($text,
                                                    $domain) : L10N\L10N::__($text));
        }
    }
