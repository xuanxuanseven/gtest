...
use Lephp\Helpers\QRCode\Data\AlphaNum;
use Lephp\Helpers\QRCode\Data\Byte;
use Lephp\Helpers\QRCode\Data\Kanji;
use Lephp\Helpers\QRCode\Data\Number;
use Lephp\Helpers\QRCode\Output\QROutputInterface;
...
class QRCode{
	...
	/**
	 * @var \Lephp\Helpers\QRCode\BitBuffer
	 */
	protected $bitBuffer;

	/**
	 * @var \Lephp\Helpers\QRCode\Data\QRDataInterface
	 */
	protected $qrDataInterface;

	/**
	 * @var \Lephp\Helpers\QRCode\Output\QROutputInterface
	 */
	 ...
	 *
	 * @param string                                      $data
	 * @param \Lephp\Helpers\QRCode\Output\QROutputInterface $output
	 * @param \Lephp\Helpers\QRCode\QROptions|null           $options
	 */
	 ...
	 *
	 * @return $this
	 * @throws \Lephp\Helpers\QRCode\QRCodeException
	 */
