...
class BaseArrayHelper
{
     ...
     * ```php
     * // working with array
     * $username = \Lephp\Helpers\ArrayHelper::getValue($_POST, 'username');
     * // working with object
     * $username = \Lephp\Helpers\ArrayHelper::getValue($user, 'username');
     * // working with anonymous function
     * $fullName = \Lephp\Helpers\ArrayHelper::getValue($user, function ($user, $defaultValue) {
     *     return $user->firstName . ' ' . $user->lastName;
     * });
     * // using dot format to retrieve the property of embedded object
     * $street = \Lephp\Helpers\ArrayHelper::getValue($users, 'address.street');
     * // using an array of keys to retrieve the value
     * $value = \Lephp\Helpers\ArrayHelper::getValue($versions, ['1.0', 'date']);
     * ```
     *
     ...
     * @throws \Lephp\Core\InvalidParamException if $array is neither an array nor an object.
     */
     ...
     * // working with array
     * $type = \Lephp\Helpers\ArrayHelper::remove($array, 'type');
     * // $array content
     * // $array = ['options' => [1, 2]];
     * ```
     *
     ...
     * ];
     *
     * $result = \Lephp\Helpers\ArrayHelper::filter($array, ['A']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * // ]
     *
     * $result = \Lephp\Helpers\ArrayHelper::filter($array, ['A', 'B.C']);
     * // $result will be:
     * // [
     * //     'A' => [1, 2],
     * //     'B' => ['C' => 1],
     * // ]
     *
     * $result = \Lephp\Helpers\ArrayHelper::filter($array, ['B', '!B.C']);
     * // $result will be:
     * // [
     * //     'B' => ['D' => 2],
     * // ]
