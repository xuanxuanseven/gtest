...
use Lephp\Core\{
    Component, Formatting, InvalidConfigException
};
use Lephp\Lephp;
use ReflectionClass;
 ...
 *
 * By default, [[\Lephp::$container]] refers to a Container instance which is used by [[\Lephp::createObject()]]
...
class Container extends Component
{
     ...
     *
     * If the class implements [[\Lephp\Core\Configurable]], the `$config` parameter will be passed as the last
     ...
     * $container->set('Lephp\db\Connection');
     *
     * // register an interface
     * // When a class depends on the interface, the corresponding class
     * // will be instantiated as the dependent object
     * $container->set('Lephp\mail\MailInterface', 'Lephp\swiftmailer\Mailer');
     *
     * // register an alias name. You can use $container->get('foo')
     * // to create an instance of Connection
     * $container->set('foo', 'Lephp\db\Connection');
     *
     ...
     *     return new \Lephp\db\Connection($config);
     * });
     * ```
     *
    ...
    protected function build($class, $params, $config)
    {
        ...
        if (!empty($dependencies) && $reflection->implementsInterface('\Lephp\Core\Configurable')) {
    ...
    public function resolveCallableDependencies(callable $callback, $params = [])
    {
        ...
        $associative = Formatting::isAssociative($params);
        ...
        foreach ($reflection->getParameters() as $param) {
            ...
            if (($class = $param->getClass()) !== null) {
                ...
                } elseif (isset(Lephp::$app) && Lephp::$app->has($name) && ($obj = Lephp::$app->get($name)) instanceof $className) {
                    $args[] = $obj;
                } else {
