...
use Lephp\Core\InvalidCallException;
use Lephp\Core\InvalidConfigException;
use Lephp\Core\InvalidParamException;
use Lephp\Core\ModelEvent;
use Lephp\Core\NotSupportedException;
use Lephp\Core\UnknownMethodException;
use Lephp\Core\YModel;
 ...
 * @since 2.0
 */
abstract class BaseActiveRecord extends YModel implements ActiveRecordInterface
{
    /**
     ...
     * @throws \Lephp\Core\InvalidParamException if relation name is wrong
