 ...
 * ```
 */
class BatchQueryResult extends BasicObject implements \Iterator
{
    /**
     * @var NewConnection the DB connection to be used when performing batch query.
     * If null, the "db" application component will be used.
     */
    public $db;
    /**
     * @var NewQuery the query object associated with this batch query.
