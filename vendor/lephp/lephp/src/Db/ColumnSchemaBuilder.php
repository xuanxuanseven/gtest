...
use Lephp;
use Lephp\Core\BasicObject as Object;
...
class ColumnSchemaBuilder extends Object
{
    ...
    /**
     * @var \Lephp\Db\NewConnection the current database connection. It is used mainly to escape strings
     ...
     * @param \Lephp\Db\NewConnection $db the current database connection. See [[$db]].
