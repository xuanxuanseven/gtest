 ...
 *
 * @property Validator[] $activeValidators The validators applicable to the current
 ...
 * @property ArrayObject|Validator[] $validators All the validators declared in the model.
 * This property is read-only.
 *
 * @author Qiang Xue <qiang.xue@gmail.com>
 * @since 2.0
 */
class YModel extends Component implements IteratorAggregate, ArrayAccess, Arrayable
{
    use ArrayableTrait;
     ...
     *
     * Lephp also provides a set of [[Validator::builtInValidators|built-in validators]].
     ...
     *
     * The form name is mainly used by [[\Lephp\widgets\ActiveForm]] to determine how to name
    ...
    public function getActiveValidators($attribute = null)
    {
        ...
        $scenario = $this->getScenario();
        foreach ($this->getValidators() as $validator) {
            if ($validator->isActive($scenario) && ($attribute === null || in_array($attribute, $validator->attributes,
                                                                                    true))
            ) {
     ...
     * [[\Lephp\validators\RequiredValidator|required]] validation rule in the
     * current [[scenario]].
     ...
     * The default implementation will log a warning message if Lephp_DEBUG is on.
    ...
    {
//        if () {
////            Lephp::trace("Failed to set unsafe attribute '$name' in '" . get_class($this) . "'.", __METHOD__);
//        }
    }
