...
class Component extends BasicObject
{
    ...
    public function __set($name, $value)
    {
        ...
        if (method_exists($this, $setter)) {
            ...
            $this->attachBehavior($name, $value instanceof Behavior ? $value : Lephp::createObject($value));
...
//        throw new UnknownPropertyException('Setting unknown property: ' . get_class($this) . '::' . $name);
     ...
     *  - an object configuration array that will be passed to [[Lephp::createObject()]] to create the behavior object.
     *
    ...
    private function attachBehaviorInternal($name, $behavior)
    {
        if (!($behavior instanceof Behavior)) {
            $behavior = Lephp::createObject($behavior);
        }
        if (is_int($name)) {
