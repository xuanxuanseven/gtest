...
class Module extends ServiceLocator
{
    ...
    public static function getInstance()
    {
        ...
        return isset(Lephp::$app->loadedModules[$class]) ? Lephp::$app->loadedModules[$class] : null;
    }
    ...
    {
        if ($instance === null) {
            unset(Lephp::$app->loadedModules[get_called_class()]);
        } else {
            Lephp::$app->loadedModules[get_class($instance)] = $instance;
        }
    }
     ...
     * This method calls [[Lephp::setAlias()]] to register the path aliases.
    ...
    public function getModule($id, $load = true)
    {
        ...
        if (isset($this->_modules[$id])) {
            if ($this->_modules[$id] instanceof Module) {
                ...
                Lephp::trace("Loading module: $id", __METHOD__);
                /* @var $module Module */
                $module = Lephp::createObject($this->_modules[$id], [$id, $this]);
     ...
     * array that can be used to create the module. In the latter case, [[Lephp::createObject()]]
